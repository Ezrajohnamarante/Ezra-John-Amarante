...
class ShopPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            _buildComputerList(context, 'Gaming'),
            _buildComputerList(context, 'Office'),
            _buildComputerList(context, 'Creator'),
            _buildComputerList(context, 'Budget'),
          ],
        ),
      ),
    );
  ...
  Widget _buildComputerList(BuildContext context, String category) {
    final computers = _getComputersByCategory(category);
  ...
  List<Computer> _getComputersByCategory(String category) {
    switch (category) {
      case 'Gaming':
        return [
          Computer(
